    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView.builder(
          itemCount: (freshVegetablesDataPakistan.length / 2).ceil(),
          itemBuilder: (context, index) {
            int firstIndex = index * 2;
            int secondIndex = index * 2 + 1;

            bool hasSecondItem =
                secondIndex < freshVegetablesDataPakistan.length;
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => SingleProductScreen(
                                    data: freshVegetablesDataPakistan[
                                        firstIndex])));
                      },
                      child: Card(
                        color: Colors.white,
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                freshVegetablesDataPakistan[firstIndex]
                                    ['product_name'],
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    "Rs.${freshVegetablesDataPakistan[firstIndex]['price']}"
                                        .toString(),
                                    style: const TextStyle(
                                        color: Color(0xff53B175),
                                        fontWeight: FontWeight.bold),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                // Add your card content here
                                Text(
                                  freshVegetablesDataPakistan[secondIndex]
                                      ['product_name'],
                                  style: const TextStyle(
                                      fontSize: 13,
                                      color: Color(0xff53B175),
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      "Rs.${freshVegetablesDataPakistan[secondIndex]['price']}"
                                          .toString(),
                                      style: const TextStyle(
                                          color: Color(0xff53B175),
                                          fontWeight: FontWeight.bold),
